...
public class HandlingWindows extends CommonMethods{
  ...
  @Test
    public void learnWindowHandling() throws InterruptedException {
      ...
      //here we are saving the window handle of the current window as a string variable
      ...
      Thread.sleep(1000);
       ...
       // Here we are taking the return type Set<String> and casting it to
       // an ArrayList<String> for easy access
        Set<String> windowSet = driver.getWindowHandles();
        ArrayList<String> windowslist = new ArrayList<>(windowSet);

        // Here we are creating for each loop to cycle through the elements of the windows
        // list and then we are making sure that the current window isn't the primary window
        ...
        for(String windowHandle:windowslist){
          if(!windowHandle.equals(primaryWindow)){
            ...
            // This method is different from drive.quit() it
            // closes specific window that is currently active
            driver.close();
          }
        }
  ...
  public void windowHandlingExample() throws InterruptedException {
   ...
   driver.navigate().to("https://magento.softwaretestingboard.com/");
    ...
    // Since driver.getWindowHandles() method returns a set of window handles
