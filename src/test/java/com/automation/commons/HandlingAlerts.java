...
public class HandlingAlerts extends CommonMethods {
    ...
    public void learnAlertHandling() throws InterruptedException {
        ...
        WebElement button4 = driver.findElement(By.id("promptButton"));
        ...
        Assert.assertTrue("User did not select dismiss the alert", selectionResult.getText().equalsIgnoreCase("you selected cancel"));
        Thread.sleep(3000);
        ...
        Assert.assertTrue("User did not type 'Hello world' in the alert", selectionResult.getText().equalsIgnoreCase("you entered Hello world"));
